...
const ProjectCard = ({
  ...
  return (
    <div className="bg-background-gradient p-3 lg:p-4 rounded-2xl lg:rounded-3xl shadow-sm group">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2 justify-center items-center lg:justify-start lg:items-start">
          <h3 className="text-center lg:text-start text-lg capitalize text-white font-medium">
            {title}
          </h3>
          <p className="text-center lg:text-start text-sm lg:text-base text-muted max-w-md">
            {description}
          </p>
        </div>
